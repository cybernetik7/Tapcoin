// Copyright (c) 2014 The TapCoin developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("TapCoin-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("TapCoin-smsg-pow"); // Make this thread recognisable
