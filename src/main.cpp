...
unsigned int nStakeMinAge       = 7 * 60 * 60;      // 4 hours
...
const string strMessageMagic = "TapCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
	...
	if(pindexBest->nHeight == 4)
        {
            nSubsidy = 80000000 * COIN; // 80 million coins premine
        }
  
    else if (pindexBest->nHeight > 150 )
    {
        nSubsidy = 2 * COIN; 
    }
...
static const int64_t nTargetTimespan = 33 * 60;  // 33 mins
...
// TapCoin: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "TapCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        */
        ...
        const char* pszTimestamp = "TapCoin 2014";
        CTransaction txNew;
        txNew.nTime = 1415476159;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
	...
	uint256 hash = block.GetHash();
        ...
        assert(block.hashMerkleRoot == uint256("0x242636f4a7b7bb1e8d5972cba0447250351854d111a7e70b42902949adc6dc0d"));
...
unsigned char pchMessageStart[4] = { 0x11, 0xb7, 0xc7, 0xaa };
