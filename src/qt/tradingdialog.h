...
private slots:
    ...
    void on_BuyTAP_clicked();
    void on_SellTAPBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputTAP_textChanged(const QString &arg1);
    ...
    QString BuyTAP(QString OrderType, double Quantity, double Rate);
    QString SellTAP(QString OrderType, double Quantity, double Rate);
